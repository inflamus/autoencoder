...
class TransmissionRPC
{
  ...
  public static function __New($url = 'http://localhost:9091/transmission/rpc', $username = null, $password = null, $return_as_array = false)
  {
	return new self($url, $username, $password, $return_as_array);
  }
}
